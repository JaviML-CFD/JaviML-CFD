...
**Co-Author** — *Aerodynamic Investigation of a Convertible Tandem-Wing UAV Using Mid-Fidelity Numerical Simulations and Propeller Interaction Experimental Data*
Presented at the **51st European Rotorcraft Forum (ERF 2025, Venice)**. Under review at *CEAS Aeronautical Journal (Springer Nature)*.

**Conference Presenter** — *Impact of Parameter Variations on the Performance of Overlapping Propellers*
Based on an extensive 484-run experimental wind tunnel campaign. Presented at the **51st ERF (Venice)** and the **21st PEGASUS Student Conference (Prague)**.
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=flat-square&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/javier-martinez-lorenzo/)

📧 javi.martinez.lorenzo@gmail.com
